...
//                MediaStore.Audio.Media.
        ...
        Cursor audioCursor = activity.getContentResolver().query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, proj, DEFAULT_SELECTION, null, null);
        if(audioCursor != null){
